...
Tags: tts, voiceover, text, speech, post, sound
Requires at least: 2.0
Tested up to: 3.2.1
Stable tag: 1.0


Professional voice over for your website. This plugin adds iWebReader player to each post and page on your Wordpress blog.
...
== Installation ==
1. Activate your service on [iWebReader](http://www.iwebreader.com/ "iWebReader") website and download the plugin
...
You can find full list of Frequently Asked Questions on [iWebReader](http://www.iwebreader.com/ "iWebReader") website.

== Screenshots ==

1. iWebReader player on default Wordpress instance.

== Changelog ==

= 1.1 =
* Fixed overall stability of the plugin
* Updated voices list with new TTS voices available in the service
...
= 1.1 =
* Simplified configuration and added new IVONA voices
...
If you have experienced any problems with this plugin please let us know by contacting our support department at [iWebReader](http://www.iwebreader.com/ "iWebReader") website.
